...
const ReadMoreButton: React.FC = () => {
  ...
  return (
    <div className="max-w-xl mx-auto text-center">
     <p className="mb-8 text-xl font-serif">
          ...
          <span className={`transition-all ease-in-out duration-500 overflow:hidden inline-block font-serif ${isExpanded ? 'max-h-[10rem] opacity-100' : 'max-h-0 opacity-0'}`}
        >
